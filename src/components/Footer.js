  ...
  return (
    <footer className="bg-black text-gray-400 py-12 px-6">
      ...
      >
        {/* 🔹 Studio Info */}
        <div>
          <h2 className="text-white text-2xl font-semibold mb-4">StudioReel</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>Email: <a href="mailto:hello@studioreel.com" className="hover:text-white transition">hello@studioreel.com</a></li>
            <li>Instagram: <a href="https://instagram.com" className="hover:text-white transition">@studioreel</a></li>
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm">
        <p className="text-gray-500">&copy; {new Date().getFullYear()} StudioReel. All rights reserved.</p>
      </div>
    </footer>
  );
}
